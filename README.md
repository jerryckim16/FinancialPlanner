...
* Phone bill
* Utilities 
* Miscellaneous (can add) different subscriptions (youtube, netflix)

Calculate federal tax rate and state tax rate for job income with standard deductions

Factors
* Targeted Age of retirement
* living costs
* Job Income
    * checks if you can get a raise
* Rent
    * searches for average rent in your area to see if cost is optimized
* Investment return
